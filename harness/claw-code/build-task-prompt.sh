...
# Claw Code uses CLAW.md (equivalent to CLAUDE.md)
SYSTEM_PROMPT=""
if [ -f /workspace/CLAW.md ]; then
  SYSTEM_PROMPT=$(cat /workspace/CLAW.md)
...
cat <<PROMPT
You are a KARO agent running as Claw Code. You have been assigned a task from your mailbox.
