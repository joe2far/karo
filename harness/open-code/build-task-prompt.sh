...
# OpenCode uses AGENTS.md as its repository instructions convention.
SYSTEM_PROMPT=""
if [ -f /workspace/AGENTS.md ]; then
  SYSTEM_PROMPT=$(cat /workspace/AGENTS.md)
...
cat <<PROMPT
You are a KARO agent running as OpenCode. You have been assigned a task from your mailbox.
